        ...
        <div className="group relative">
          ...
          <div className="relative flex items-center rounded-full border border-neutral-700/50 bg-neutral-900/80 backdrop-blur-sm transition-colors duration-300 focus-within:border-green-500/50">
            ...
            <button
              ...
              className="mr-1.5 flex items-center gap-2 whitespace-nowrap rounded-full bg-green-600 px-4 py-2 font-medium text-sm text-white transition-all duration-300 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-neutral-900 enabled:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 sm:px-5"
            >
              {status === "loading" ? (
                <>
                  <svg
                ...
                >
                  ...
                  <path d="M2 10l15 2-15 2V10z" fill="rgba(255,255,255,0.3)" />
                </svg>
              )}
            </button>
          </div>
